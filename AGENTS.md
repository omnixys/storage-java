...
> Repository development instructions for **storage** (Shared Package).
> Stack: java-maven. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

S3/MinIO file storage service.

- Repository path: `packages/java/storage` (relative to the Omnixys root)
...
src/main/java/com/omnixys/storage/
...
published to GitHub Packages (com.omnixys); consumed by services and other packages
